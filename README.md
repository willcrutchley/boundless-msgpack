...
With python3 and msgpack-python installed, place all the msgpack files you want to convert in the 'msgpack' folder, and the script will output to the 'converted' folder. Just double click the script.py file, or from command line do `python3 [path_to_script.py]`, then watch the magic happen!
